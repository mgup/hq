    ...
    Nokogiri::XML::Builder.new(encoding: 'UTF-8') { |xml|
      xml.application {
        ...
        if competitive_group_target_item
          xml.target ", договор № #{competitive_group_target_item.target_organization.contract_number} от #{l competitive_group_target_item.target_organization.contract_date}, #{competitive_group_target_item.target_organization.name}"
        else
          xml.target ''
        end
