prawn_document margin: [28.34645669291339, 28.34645669291339,
  ...
  pdf.font_size 11 do
    ...
    pdf.font_size 10 do
      pdf.text "* В соответствии с Порядком учета индивидуальных достижений поступающих при приёме на обучение в МГУП имени Ивана Федорова в 2016/2017 учебном году поступающему может быть начислено за индивидуальные достижения не более #{@campaign.id == 22016 ? 20 : 10} баллов суммарно."
    end
    ...
    pdf.move_down 10
    pdf.text 'на своем заседании рассмотрели список индивидуальных достижений поступающих и постановили присвоить итоговые баллы:'
    pdf.table data
  end
  ...
  @campaign.achievement_types.each do |achievement_type|
    ...
    pdf.font_size 11 do
     ...
     achievements.each_with_index do |a, ind|
      ...
      pdf.move_down 15
      pdf.text 'на своем заседании рассмотрели список поступающих и постановили установить следующие баллы за рассматриваемое индивидуальное достижение:'
      pdf.table data
    end
  end
end
