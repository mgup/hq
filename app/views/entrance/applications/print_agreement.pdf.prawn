prawn_document margin: [28.34645669291339, 28.34645669291339,
  ...
  pdf.move_down 10
  pdf.text "поступаю#{@application.entrant.male? ? 'щего' : 'щей'}", indent_paragraphs: 300
  ...
  text = ["Я, #{@application.entrant.full_name}, "]

  text << "подтверждаю согласие на зачисление на направление подготовки #{@application.competitive_group_item.direction.description}, профиль #{@application.profile ? @application.profile.name : 'не указан' }, #{@application.education_form_name} форма обучения, #{@application.is_payed ? 'договорная' : 'бюджетная'} основа обучения, предоставляю оригинал документа об образовании."
  ...
  pdf.text '_______________________' + (' ' * 90) + '_______________________'
  ...
  pdf.move_down 35
  pdf.text "Ф.И.О. (полностью)#{' '*20}<u>#{@application.entrant.full_name}</u>", inline_format: true
  ...
  pdf.move_down 5
  pdf.stroke_polygon [12,213], [12,203], [22,203], [22,213]
  ...
  pdf.move_down 5
  pdf.stroke_polygon [12,163], [12,153], [22, 153], [22,163]
