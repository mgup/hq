prawn_document margin: [56.692913386, 28.34645669291339,
  ...
  pdf.font_size 12
  pdf.text 'Он необходим для оплаты обучения черезе терминалы СДМ-Банка.'
  ...
  pdf.text '5) Выберите оплачиваемую услугу — «Дистанционное обучение».', align: :justify
  pdf.text "6) Введите ваш личный номер студента #{@contract.student_id}.", align: :justify
 ...
 согласно договору и графику платежей и нажмите кнопку «Принять».', align: :justify
  ...
  pdf.text '10) В том случае если сумма платежа превышает 15 000 руб., то будет выведено информационное окно и в рамках одной сессии должно быть сделано несколько платежей.', align: :justify
