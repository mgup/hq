    ...
    pdf.font_size 12 do
        ...
        if '1' == params[:sign]
          ...
          data = [['Начальник управления контингента образовательных программ', 'Горина Ю. Е.'],
                  ['Начальник Центра по работе со студентами Высшей школы печати и медиаиндустрии', 'Бутарева Л. Л.']]
        elsif '7' == params[:sign]
          data = [['Директор Высшей школы печати и медиаиндустрии', 'Антипов К. В.']#,
                  #['Начальник студенческого отдела кадров', 'Бутарева Л. Л.']
                  ]
        elsif '5' == params[:sign]
          data = [['Заместитель начальник Центра по работе со студентами Высшей школы печати и медиаиндустрии', 'Уткина Н. Е.']#,
                  #['Начальник студенческого отдела кадров', 'Бутарева Л. Л.']
                  ]
        else
          positions = []
