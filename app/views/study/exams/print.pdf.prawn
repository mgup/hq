prawn_document margin: [28, 20, 28, 28],
  ...
  pdf.font_size 9 do
    pdf.text_box 'Федеральное государственное бюджетное образовательное учреждение высшего профессионального образования', at: [37, 842 - 28 - 8]
    pdf.text_box '«МОСКОВСКИЙ ПОЛИТЕХНИЧЕСКИЙ УНИВЕРСИТЕТ»', at: [177, 842 - 38 - 10]
    pdf.text_box 'Высшая школа печати и медиаиндустрии', at: [197, 842 - 48 - 10]
  end
  # pdf.text_box '«МОСКОВСКИЙ ГОСУДАРСТВЕННЫЙ УНИВЕРСИТЕТ ПЕЧАТИ ИМЕНИ ИВАНА ФЕДОРОВА»', at: [30, 842 - 28 - 18]
  pdf.line [0, 842 - 56 - 15], [595 - 56, 842 - 56 - 15]
  if @exam.is_repeat?
    pdf.text_box "ДОПОЛНИТЕЛЬНАЯ ЭКЗАМЕНАЦИОННАЯ (ЗАЧЕТНАЯ) ВЕДОМОСТЬ № #{@exam.id}", at: [68, 842 - 75]
  elsif @exam.validation?
    pdf.text_box 'ВЕДОМОСТЬ КОНТРОЛЯ УСПЕВАЕМОСТИ', at: [160, 842 - 75]
  else
    pdf.text_box "ЭКЗАМЕНАЦИОННАЯ (ЗАЧЁТНАЯ) ВЕДОМОСТЬ № #{@exam.id}", at: [120, 842 - 75]
