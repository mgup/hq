...
<xsl:stylesheet version="1.0"
                    ...
                    <fo:block font="12pt PT Serif">
                      <xsl:choose>
                        <xsl:when test="not(./sign/date)">
                          от &laquo;______&raquo; ______________ 2016 г.
                        </xsl:when>
                        <xsl:otherwise>
  ...
  <xsl:template match="employee">
    ...
    <fo:block font="12pt PT Serif">
      &laquo;______&raquo; _______________ 2016 г.
    </fo:block>
      ...
      <fo:page-sequence master-reference="main">
        ...
        <fo:flow flow-name="xsl-region-body">
          <fo:block font="12pt PT Serif" text-indent="260">
              ...
              <!--</fo:block>-->
              <fo:block>
                    Первый проректор МГУП имени Ивана Федорова
              </fo:block>
              <fo:block space-before="5pt">
                  ________________________ Г.В. Кожевников
              </fo:block>
              <fo:block space-before="5pt">
