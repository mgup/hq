...
ActiveRecord::Schema.define(version: 20160713075353) do

  create_table "1", id: false, force: :cascade do |t|
    t.integer "id",         limit: 4
    t.string  "last_name",  limit: 22
    t.string  "first_name", limit: 18
    t.string  "patronym",   limit: 30
  end
  ...
  create_table "dipmst_specialities", id: false, force: :cascade do |t|
    t.integer "Код",           limit: 4,                                default: 0,  null: false
    t.text    "Специальность", limit: 16777215,                                      null: false
    t.string  "Специализация", limit: 0,                                default: "", null: false
    t.string  "Квалификация",  limit: 0,                                default: "", null: false
    t.decimal "Срок_Обучения",                  precision: 2, scale: 1,              null: false
    t.text    "Название",      limit: 16777215,                                      null: false
    t.text    "Название_Спец", limit: 16777215,                                      null: false
  end
  ...
  create_table "entrance_entrants", force: :cascade do |t|
    ...
    t.boolean  "foreign",                       limit: 1,   default: false
  end
  ...
  create_table "study_geks", force: :cascade do |t|
    t.integer  "position_id", limit: 4, null: false
    t.integer  "study_year",  limit: 4, null: false
  ...
  create_table "все_группы", id: false, force: :cascade do |t|
    ...
    t.integer "Курс",              limit: 4
    t.integer "Код_Специальности", limit: 4,                             null: false
    t.integer "КодПлана",          limit: 4,                default: 0,  null: false
    t.string  "УчебныйГод",        limit: 9,                default: "", null: false
    t.integer "Форма_Обучения",    limit: 4,                default: 0,  null: false
    t.integer "Уровень",           limit: 4
    t.decimal "СрокОбучения",                 precision: 2, default: 0,  null: false
  ...
  create_table "импортстудентыосновныеполя", id: false, force: :cascade do |t|
    ...
    t.string  "Номер_Паспорта",     limit: 20
    t.date    "Дата_Выдачи"
  ...
  create_table "импортфакультеты", id: false, force: :cascade do |t|
    ...
    t.integer "Тип_обучения", limit: 4,   default: 0,  null: false
    t.string  "Декан",        limit: 0,   default: "", null: false
    t.string  "Секретарь",    limit: 0,   default: "", null: false
  end
