...
ActiveRecord::Schema.define(version: 20141107122252) do
  ...
  create_table "entrance_use_check_results", force: true do |t|
    t.text     "exam_name"
    t.integer  "score"
    t.integer  "exam_result_id"
    t.integer  "use_check_id"
    t.datetime "created_at"
    t.datetime "updated_at"
    t.integer  "year"
  end
  ...
  create_table "nationality_types", force: true do |t|
    t.string   "name"
    t.datetime "created_at"
    t.datetime "updated_at"
  end
  ...
  create_table "template_student_group_statuses", force: true do |t|
